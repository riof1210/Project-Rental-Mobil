...
if (isset($_POST['tambah'])) {
    ...
    if ($query) {
        ...
        header('Location: merk.php?status=sukses');
    } else {

        //kalau gagal alihkan ke halaman index.html
        //dengan status=gagal
        header('Location: merk.php?status=gagal');
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="sidebar transition">
        ...
        <ul>
            ...
            <li>
                <a href="pemesanan.php" class="transition">
